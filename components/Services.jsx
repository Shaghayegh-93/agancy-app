      ...
      <div className=" flex flex-wrap justify-evenly">
        {services.map((service) => (
          <Link className=" " passHref key={service.id} href="/">
            <div className="w-[250px] h-[250px] md:w-[500px] md:h-[500px] bg-slate-100 flex items-center justify-center p-[8px] md:p-[10px]  mb-[50px] relative cursor-pointer group ">
